...
start_urls <- paste0("https://www.anibis.ch/de/c/motorrad-velo-motorraeder?fts=Kawasaki%20Z650&pi=",
                     pages) %>% 
  as_tibble() %>% 
  rename(url = value)
...
```{r, eval=FALSE, echo=FALSE}
write_csv(listings_clean, "C:/Users/mathi/OneDrive/R/Data Visualisation/Used Cars Web Scraping/z650-clean.csv")
```
